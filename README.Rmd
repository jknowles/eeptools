...
[![Downloads](http://cranlogs.r-pkg.org/badges/eeptools)](https://cran.r-project.org/web/packages/eeptools/index.html)
...
datasets are also used in the [R Bootcamp for Education Analysts](www.jaredknowles.com/r-bootcamp)
