utils::globalVariables(c("adv", "grade", "count", "id"))
...
#' \url{http://www.gse.harvard.edu/~pfpie/index.php/sdp/tools}
#' @references Visit the Strategic Data Project online at:  \url{http://www.gse.harvard.edu/sdp}
#' @examples 
#' data(stuatt)
#' head(stuatt)
"stuatt"
